# usage: --script search-member-in-class --input [class-name] --output result.txt
...
db = db_instance()
sql = "SELECT class_name, member_name, type_class_name, modifiers FROM member_table WHERE class_name = '__input__'"
