# usage: --script search-string --input [string-name] --output result.txt
...
db = db_instance()
sql = "SELECT value, method_name,method_desc,class_name,jar_name FROM string_table WHERE value LIKE '%__input__%'"
