# usage: --script search-method-name --input [method-name] --output result.txt
...
db = db_instance()
sql = "SELECT method_name, method_desc, class_name, access FROM method_table WHERE method_name = '__input__'"
